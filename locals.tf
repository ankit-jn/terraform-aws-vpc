locals {
    ...
    create_igw_ipv4_route = var.create_vpc ? ((var.create_igw && var.create_igw_ipv4_route) ? true : false) : var.create_igw_ipv4_route
    create_igw_ipv6_route = var.create_vpc ? ((var.create_egress_only_igw && var.create_igw_ipv6_route) ? true : false) : var.create_igw_ipv6_route
